    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <label htmlFor="project-status-filter" className="text-sm font-medium text-gray-700 dark:text-slate-300">
            Status
          </label>
          <select
            ...
            className="text-sm rounded-lg border border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-200 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
          ...
          {projects.map((p) => (
            <div
              ...
              className={`card card-body rounded-xl shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-gray-100 dark:border-slate-700/50 ${
                p.status?.toLowerCase() === 'archived' ? 'opacity-70' : ''
              }`}
            >
