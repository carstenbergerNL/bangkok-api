                  ...
                  <tr key={r.id}>
                    ...
                    <td className="text-right">
                      <div className="table-actions">
                        <button type="button" onClick={() => openEdit(r)} className="table-link inline-flex items-center gap-1.5">
                        ...
                        <button type="button" onClick={() => openDelete(r)} className="table-link-danger inline-flex items-center gap-1.5">
