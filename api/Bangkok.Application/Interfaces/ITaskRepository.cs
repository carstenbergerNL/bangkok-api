...
public interface ITaskRepository
{
    ...
    System.Threading.Tasks.Task<IReadOnlyList<ProjectTask>> GetByProjectIdAsync(Guid projectId, TaskFilterRequest? filter, CancellationToken cancellationToken = default);
