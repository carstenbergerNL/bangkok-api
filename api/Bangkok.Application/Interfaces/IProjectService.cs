...
public interface IProjectService
{
    ...
    Task<(CreateProjectResult Result, ProjectResponse? Data, string? ErrorMessage)> CreateFromTemplateAsync(Guid templateId, CreateProjectRequest request, Guid currentUserId, CancellationToken cancellationToken = default);
